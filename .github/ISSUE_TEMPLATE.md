...
Be descriptive: "it doesn't work" does not describe what the behavior actually is -- instead, say "the client returns an error with valid keys"  Copy and paste logs, and include any URLs.
